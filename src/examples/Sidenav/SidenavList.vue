    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="this.$store.state.isRTL ? 'لوحة القيادة' : 'ข้อมูลลูกค้า'"
        >
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-item
          url="/Item"
          :class="getRoute() === 'Item' ? 'active' : ''"
          :navText="this.$store.state.isRTL ? 'لوحة القيادة' : 'ข้อมูลวัสดุ'"
        >
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="this.$store.state.isRTL ? 'لوحة القيادة' : 'ข้อมูลสินค้า'"
        >
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="this.$store.state.isRTL ? 'لوحة القيادة' : 'ขายสินค้า'"
        >
          <template v-slot:icon>
            <!-- <i class="ni ni-basket text-success text-sm opacity-10"></i> -->
            <i class='fas fa-cart-plus text-danger text-sm opacity-10' style='font-size:24px'></i>
          </template>
        </sidenav-item>
      </li>
      <li class="nav-item">
