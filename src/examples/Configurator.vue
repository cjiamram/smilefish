...
import { deactivateDarkMode,activateDarkMode } from "@/assets/js/dark-mode";
export default {
  name: "configurator",
  props: ["toggle"],
  methods: {
    ...mapMutations(["navbarMinimize","navbarMaximize", "navbarNormal","sidebarType", "navbarFixed"]),
